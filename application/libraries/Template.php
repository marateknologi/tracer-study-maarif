...
class Template
{
    ...
    public $_app_name = "Trace Center";
    //isikan detail tambahan aplikasi anda disini
    public $_app_slogan = "Ma'arif NU DIY";
    public $_meta_keyword = "tracer study";
    public $_logo_website = "";
    public $_meta_deskripsi = '';
    ...
    public function _render_page($view, $data = null, $returnhtml = false)
    {
        ...
        if (isset($row['id_situs'])) {
            ...
            $data['_meta_deskripsi'] = $this->_meta_deskripsi;
            $data['_meta_keyword'] = $this->_meta_keyword;
            $data['_logo_website'] = $this->_logo_website;
        }
