...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card login-card" style="height:600px">
	<div class="logo">
	    <a style="color:#333d42" href="javascript:void(0);"><?php echo $_app_name; ?></a>
	    <small style="color:#333d42"><?php echo $_app_slogan; ?></small>
	</div>
            ...
            <div class="body">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <?php echo form_input($username, '', 'style="border-radius:20px" class="form-control" placeholder="Nama" required autofocus') ?>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <?php echo form_input($email, '', 'style="border-radius:20px" class="form-control" placeholder="Alamat Surel" required') ?>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <?php echo form_input($password, '', 'style="border-radius:20px" class="form-control" minlength="5" placeholder="Kata Sandi" required') ?>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <?php echo form_input($passconf, '', 'style="border-radius:20px" class="form-control" minlength="5" placeholder="Konfirmasi Kata Sandi" required') ?>
                    </div>
                </div>
                ...
                <?php echo form_submit('submit', 'Registrasi Sekarang', 'style="border-radius:15px" class="btn btn-block btn-lg bg-pink waves-effect"') ?>
