...
?>
		...
		<div class="input-group">
		    ...
		    <div class="form-line">
			<?php echo form_input($email, '', 'style="border-radius:20px" class="form-control" placeholder="Masukkan Alamat Surel" required autofocus'); ?>
		    </div>
		</div>
		<?php echo form_submit('reset-akun', 'Reset Kata Sandi', 'style="border-radius:20px" class="btn btn-block btn-lg bg-pink waves-effect"'); ?>
