        ...
        <div class="card">
            <div class="body">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <?php echo form_input($password, '', 'style="border-radius:15px" class="form-control" minlength="5" placeholder="Kata Sandi" required') ?>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                ...
                <?php echo form_submit('submit', 'Perbarui Kata Sandi', 'style="border-radius:15px" class="btn btn-block btn-lg bg-pink waves-effect"') ?>
